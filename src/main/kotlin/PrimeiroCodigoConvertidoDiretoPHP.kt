...
fun base64Execute() {
    ...
    val convertidoPhp = PrimeiroCodigoConvertidoDiretoPHP()
    val result1 = convertidoPhp.baseBase2Dec("DLZvS", 64)
    val result2 = convertidoPhp.baseBase2Dec("DL6dA", 64)
    val result3 = convertidoPhp.baseBase2Dec("x,R0", 64)
    val result4 = convertidoPhp.baseBase2Dec("DL8bn", 64)
    val result5 = convertidoPhp.baseBase2Dec("x5FK", 64)
    println(result1)
    println(result2)
    println(result3)
    println(result4)
...
class PrimeiroCodigoConvertidoDiretoPHP {
